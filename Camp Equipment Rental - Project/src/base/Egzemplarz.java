...
public class Egzemplarz {
    ...
    public String toString(){
        return resource.getString("egzemplarz.toString1")+sprzet.getNazwa()
                +resource.getString("egzemplarz.toString2")+nrEgzemplarza
                +resource.getString("egzemplarz.toString3")+listaRezerwacji.size();
    }
